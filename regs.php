                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="post" action="regs.php" accept-charset="UTF-8">
                            ...
                            <option value="1" >Manipal University Jaipur</option>
                              <option value="2" >Manipal Acaedmy of Higher Education</option>
                              <option value="3" >Vellore Institute of Technology</option>
                              <option value="4" >SRM</option>
                              <option value="5" >Sir M Visvesvaraya institute of Technology</option>
                            </select>
